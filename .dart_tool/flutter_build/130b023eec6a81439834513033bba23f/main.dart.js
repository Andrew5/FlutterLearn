...
(function dartProgram() {
  ...
  var A = {
    ...
    main0(args) {
      A.print(A.getRuntimeType(new A.JsLinkedHashMap(type$.JsLinkedHashMap_dynamic_dynamic)));
    }
  },
  J = {
  ...
  A.main_closure0.prototype = {
    call$0() {
      if (type$.dynamic_Function_List_String._is(A.lib_15_class_abstract__main$closure()))
        return A.main0(A._setArrayType([], type$.JSArray_String));
      return type$.dynamic_Function._as(A.lib_15_class_abstract__main$closure()).call$0();
    },
    $signature: 4
  };
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(A.SkiaFontCollection.prototype, "get$_getArrayBuffer", "_getArrayBuffer$1", 63);
    var _;
    ...
    _instance_1_u(A.KeyboardBinding.prototype, "get$_onKeyData", "_onKeyData$1", 17);
    ...
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 53);
    _static_1(A, "lib_15_class_abstract__main$closure", "main0", 49);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(JavaScriptObject)", "Null(JavaScriptObject)", "bool(FlutterHtmlKeyboardEvent)", "@()", "Null(@)", "~(String,@)", "~(ByteData?)", "@(@)", "Null()", "~(~())", "Future<~>(~(JavaScriptObject),~(Object?))", "JavaScriptObject(JavaScriptObject)", "~(Object?)", "~(@)", "KeyData()", "bool(JavaScriptObject)", "bool(KeyData)", "@(JavaScriptObject)", "~(bool)", "List<JavaScriptObject>()", "~(JavaScriptObject?)", "Promise<1&>([JavaScriptObject?])", "~(Object?,Object?)", "~(Uint8List,String,int)", "Object?(Object?)", "Future<Null>()", "String(String)", "bool(int,int)", "~(List<@>,JavaScriptObject)", "~(Iterable<PointerData>)", "_ButtonSanitizer()", "Future<RegisteredFont?>()", "_PointerState()", "DateTime()", "~(Timer)", "bool(Object?)", "ByteBuffer(@)", "Promise<1&>()", "@(@,String)", "@(String)", "Null(~())", "String(String,String)", "Future<ServiceExtensionResponse>(String,Map<String,String>)", "Null(@,StackTrace)", "~(int,@)", "~(Object,StackTrace)", "~(Object[StackTrace?])", "Null(Object,StackTrace)", "~(List<String>)", "bool(@)", "List<CodeunitRange>()", "~(Symbol0,@)", "Object?(@)", "~(String,int?)", "int(int,int)", "Uint8List(@,@)", "Null(~)", "~(String,String)", "@(Object?)", "JsFunction(@)", "JsArray<@>(@)", "JsObject(@)", "Future<ByteBuffer>(JavaScriptObject)", "Object?()", "_Channel()", "int()", "String()", "String(int)", "int(@,@)", "int(Object?)", "~(int,bool(FlutterHtmlKeyboardEvent))", "bool(Object?,Object?)", "~(String,int)", "_Future<@>(@)"],
